...
H5VL_log_datatype_get(void *dt, H5VL_datatype_get_t get_type, hid_t dxpl_id, void **req, va_list arguments)
{
    ...
    ret_value = H5VLdatatype_get(o->under_object, native_plugin_id, get_type, dxpl_id, req,
                                 arguments);
...
H5VL_log_object_open(void *obj, H5VL_loc_params_t loc_params, H5I_type_t *opened_type, hid_t dxpl_id, void **req)
{
    ...
    new_obj->under_object = H5VLobject_open(o->under_object, loc_params, native_plugin_id,
                         ...
                         hid_t dxpl_id, void **req, va_list arguments)
{
    ...
    H5VLobject_specific(o->under_object, loc_params, native_plugin_id, specific_type, dxpl_id,
                        req, arguments);
...
static void *
H5VL_log_dataset_create(void *obj, H5VL_loc_params_t loc_params, const char *name, hid_t dcpl_id,
                        hid_t dapl_id, hid_t dxpl_id, void **req)
{
    H5VL_log_t *dset;
    H5VL_log_t *o = (H5VL_log_t *)obj;
                      ...
                      hid_t dxpl_id, void **req)
{
    ...
    dset->under_object = H5VLdataset_open(o->under_object, loc_params, native_plugin_id, name,
                                          dapl_id, dxpl_id, req);
